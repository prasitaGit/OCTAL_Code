...
class NetBA(nn.Module):
    def __init__(self, dropout = 0.1, in_channels = 64, dim = 256, out_channels = 128):#,init_eps=np.random.uniform(1.5, 99.5),learn_eps=True):
        super(NetBA, self).__init__()


        self.dropout = dropout

        self.conv1 = GINConv(in_channels,dim)
